...
class GSYTabBarWidget extends StatefulWidget{
  ...
  const GSYTabBarWidget({Key key, this.type, this.tabItems,
    this.tabViews, this.backgroundColor,
    this.indicatorColor, this.title})
      : super(key: key);
  ...
  _GSYTabBarState createState() {
    return new _GSYTabBarState(type, tabItems, tabViews, backgroundColor, indicatorColor, title);
  }
...
class _GSYTabBarState extends State<GSYTabBarWidget> with SingleTickerProviderStateMixin{
  ...
  _GSYTabBarState(this._type, this._tabItems, this._tabViews,
      this._backgroundColor, this._indicatorColor, this._title) : super();
